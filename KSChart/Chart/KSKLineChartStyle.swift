...
// MARK: - 图表样式配置类
public class KSKLineChartStyle {
    ...
    //十字线颜色
    public var crosshairColor: UIColor    = UIColor.white

    //文字颜色
    public var textColor: UIColor         = UIColor.clear

    //选中点的显示的框背景颜色
    public var selectedBGColor: UIColor   = UIColor.clear

    //选中点的显示的文字颜色
    public var selectedTextColor: UIColor = UIColor.clear
